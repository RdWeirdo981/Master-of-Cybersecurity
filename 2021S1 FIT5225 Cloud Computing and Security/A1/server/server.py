...
def get_labels(labels_path):
    ...
    lpath = os.path.sep.join(["yolo_tiny_configs/", labels_path])

    print("yolo_tiny_configs/")
...
def get_weights(weights_path):
    ...
    weightsPath = os.path.sep.join(["yolo_tiny_configs/", weights_path])
    return weightsPath


def get_config(config_path):
    configPath = os.path.sep.join(["yolo_tiny_configs/", config_path])
    return configPath
...
def main():
    try:
        ...
        imagefile = json.loads(imagefile)  # imagefile now is a dict: {'id':xxxx, 'image': yyyy}
